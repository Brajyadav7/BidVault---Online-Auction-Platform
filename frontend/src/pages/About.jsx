...
<section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 lg:pl-[300px] bg-background text-foreground">
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">
            Introduced by <span className="font-semibold text-primary">Braj Yadav</span>, BidVault was born out of a 
      ...
      <p className="mt-10 text-muted-foreground text-sm text-center">
        © 2025 BidVault. Crafted with ❤️ by <span className="text-primary font-semibold">Braj Yadav</span>.
      </p>
    </section>
  );
};
